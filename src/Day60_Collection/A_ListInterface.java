...
import Day54_Abstraction.CarsTask.Car;
...
/*
        ...
        for( List<String>  eachGroup : groups ){  //  Tum  guruplari yazar
            ( (Stack)eachGroup ).pop();// pop yaparsak  tum guruplarda son  ogrenciyi silecek.
...
/*
       // Odev
        ...
        List< List<Car> >  cars = new ArrayList<>();
         ...
         cars.addAll(Arrays.asList(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>()
         ));
